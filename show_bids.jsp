...
<body>
    ...
    <nav class="navbar navbar-expand-sm fixed-top">
        ...
        <div class="dropdown">
            <button class="btn btn-light dropdown-toggle"
                style="margin-left: 6em;margin-right: 5px; border-radius: 10px;" type="button" id="dropdownMenuButton"
    ...
    <div class="container">
        <div class="row">
            <ol class="col-12 breadcrumb">
                ...
                <li class="breadcrumb-item active">Your Bids</li>
            </ol>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row row-content" >
            <h2 class="col-12 mt-4" align="center" style="font-family: 'Vollkorn SC', serif; font-size: 45px">Your Bids
            </h2>
    ...
    <div id="mychat" class="chat" style="font-family: 'Vollkorn SC', serif;">
        ...
        <div class="chat-header">
          <div class="profile">
            <div class="left ml-2">
                <img  id="pp" style="width:40px; height:40px; border-radius: 50%;  margin-bottom:10px; margin-right:5px;">
    ...
    <script src="static/js/show_bids.js"></script>
